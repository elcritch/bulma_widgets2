  ...
  defmodule EventCommands do
    ...
    @moduledoc """
      Apply a function with event data, or a list of functions:
          ...
          extra_actions={[
            {Action.EventCommands, commands: fn x -> Logger.info("HI: \#{inspect x}!!!") end}
          ]}
          extra_actions={[
            {Action.EventCommands, commands: [fn x -> Logger.info("HI: \#{inspect x}!!!") end]}
          ]}
    ...
    def call(%Action{} = evt, opts) do
      ...
      # Logger.debug("Action:EventCommands: opts: #{inspect(opts)} ")
      # Logger.debug("Action:EventCommands: state: #{inspect(commands)} ")
      evt! =
